...
%        TODO: remove next line
    ...
    \section{Zadania}
    \begin{itemize}
        \item klastrowanie (jak zmienia się przynależność kraju do klastrów)
        \item ważne wydarzenia (daty) podawane w formie pliku na wejście jako punkt zaczepienia do poszukiwań
        \item
        \item
    \end{itemize}
