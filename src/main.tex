...
%    W którym momencie który agent powinien zaprzestawać dalszej analizy?
    ...
    charakteryzującej się najmniejsza procentową ilością zdarzeń \textit{Engage in negotiation}.
    ...
    \begin{figure}[!htp]
        ...
        \caption{Procentowa liczba zdarzeń Engage in negotiatio dla poszczególnych krajów. (źródło: opracowanie własne)}
        \label{fig:Power-Client:ERC:Mentions:SumUp:Engage in negotiatio}
    \end{figure}
    Na wykresie~\ref{fig:Power-Client:ERC:Mentions:SumUp:Engage in negotiatio} Niemcy, USA oraz Rosja są w grupie,
    charakteryzującej się niską procentową ilością zdarzeń \textit{Engage in negotiatio}.
