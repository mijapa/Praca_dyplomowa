...
%    Na podstawie wyników opisanych w rozdziale~\ref{ch:ewaluacja} można powiedzieć, że.
    ...
    Pierwszą z propozycji jest rozbudowa systemu agentowego o kolejne elementy.
    ...
    \begin{itemize}
        ...
        \item liczba silnych relacji sojuszniczych,
        \item liczba silnych relacji wrogich.
    \end{itemize}

    \subsection{Badanie przynależności do klastrów}
    Zarówno w odniesieniu do krajów jak i relacji możliwe jest badanie przynależności do klastrów.
    ...
    \begin{itemize}
        ...
        \item powiązanie zmiany relacji (np.: sojusznik ->wróg) z wydarzeniami,
        \item procentowa (w czasie) przynależność do tego samego klastra,
    ...
    \subsection[Filtrowanie relacji]{Filtrowanie relacji/krajów na podstawie wartości progowej}
...
%    \subsection{Badanie korelacji z danymi zewnętrznymi}
%    WHO
%    Bank Światowy
