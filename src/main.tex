...
%        TODO: remove next line
    ...
    \begin{enumerate}
        ...
        To pole jest odpowiednie dla tych którzy potrzebują dosępu do zdarzeń w wysokiej rozdzielczości czasowej,
...
%    todo Dlaczego system agentowy a nie obiektowy?


    \chapter{Przegląd dziedziny}\label{ch:przegląd-dziedziny}
    W tym rozdziale w części~\ref{sec:wzorce} przenalizowane zostały prace dotyczące wzorców w zbiorach danych.
    W części~\ref{sec:zastosowania} przeanalizowane zostały prace pokazującee możliwe zastosowania zbioru GDELT.
    ...
    W części~\ref{subsec:wzorce-w-sieciach-społecznościowych} przenalizowane zostały prace dotyczące wzorców w sieciach społecznościowych.
    ...
    \subsection{Analiza obrazu Chin w masmediach}
    ...
    \subsection{Rozrzeszenie medodologi Gaia - ROADMAP}
    ...
    \subsection{Event Base Code}\label{sec:event-base-code}
    ...
    Tabele przedstawiające krańcowe wartości miar w poszczeólnych klastrach znajdują się w dodatku~\ref{subsec:klastrowanie-kmeans---polska}.
    ...
    Tabele przedstawiające krańcowe wartości miar w poszczeólnych klastrach znajdują się w dodatku~\ref{subsec:klastrowanie-kmeans---tajwan}.
    ...
    Najciekawsze wydają się wyniki dla 3 klastrów.
    Tabele przedstawiające krańcowe wartości miar w poszczeólnych klastrach znajdują się w dodatku~\ref{subsec:klastrowanie-kmeans---syria}.
