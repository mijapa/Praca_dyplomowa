...
\begin{document}
    ...
    pozwalają na~diagnozowanie świata rzeczywistego i skuteczne wyciąganie wniosków.
    ...
    \textit{GDELT 2.0 EVENT DATABASE} oraz
    \textit{GDELT 2.0 GLOBAL KNOWLEDGE GRAPH}\@.
    ...
    Aktualnie (stan na~15X2021r.) tabela \textit{gdelt-bq:gdeltv2.events} zawiera prawie 600 milionów wierszy
    ...
    że część metryk szybko reaguje na~zdarzenia związane z~przemocą.
...
%    powiększa stronę aby część zdania nie trafiła pod~rysunek
    ...
    charakteryzującej się niską procentową ilością zdarzeń \textit{Express intent to~cooperate- not specified below}.
    \enlargethispage{1\baselineskip}
...
%    \subsubsection{Spektralne}
    ...
    Wykres~\ref{fig:Connection strength DEU to POL and POL to DEU Pearson cross correlation 2015-2020} przedstawia korelację krzyżową siły połączenia Niemiec i~Polski oraz Polski i~Niemiec w~latach 2015-2020.
    ...
    Cele pracy~\ref{sec:cele-pracy}, którymi były analiza wydarzeń politycznych i~poszukiwanie wzorców, zostały osiągnięte.
