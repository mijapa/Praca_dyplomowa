...
%    \end{figure}
    ...
    \begin{enumerate}
        \item Agent Szukający Wzorców \begin{enumerate}
                                          \item Agent szukający wzorców w danych GDELT \begin{enumerate}
                                          ...
                                          \end{enumerate}
                                          \item Agent szukający wzorców w danych Banku Światowego \begin{enumerate}
                                                                                                      \item Agent Szukający Wzorców Statycznych \begin{enumerate}
                                          ...
                                          \end{enumerate}
        \end{enumerate}
        \item Agent Poszukujący Korelacji
        \item Agent Poszukujący Trendów
